...
export const dict = {
  ...
  about: {
    ja: 'サラシックキャピタルは、<br class="sp">日本とオーストラリアを拠点に、<br class="sp">不動産事業と宿泊事業を展開する企業です。<br class="sp"><br class="sp">私たちは「地域と共に、未来へ続く価値を創造する」を<br class="sp">組織理念に、次の100年に繋がる事業活動を<br class="sp">展開してまいります。<br class="sp"><br class="sp">不動産事業では、売買・賃貸管理・仲介を中心に、<br class="sp">地域の個性と暮らしに寄り添う事業活動を行います。<br class="sp"><br class="sp">宿泊事業では、東海エリアを中心に<br class="sp">「木石」の思想を取り入れ、土地の空気を存分に<br class="sp">体感できる滞在を目指しています。<br class="sp"><br class="sp">多様な文化圏のプロフェッショナルが集うチームとして<br class="sp">地域の未来につながる新しい形の不動産・宿泊体験を<br class="sp">創造していきます。',
  ...
  recruit: {
    ja:'私たちは不動産と宿泊という二つの軸から地域の価値を創出する会社です。柔軟な発想や誠実さを大切にし、長く続く価値を一緒に生み出すメンバーを募集しています。',
