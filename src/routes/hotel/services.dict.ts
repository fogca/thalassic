...
export const dict = {
  ...
  concept: {
    ja: '名古屋の空気を静かに味わう宿泊体験。<br><br class="sp">木と石が持つ静かな調和を基調に、<br class="sp">名古屋という都市の文化と感性を<br class="sp">再発見するための滞在を創ります。<br><br>日本の伝統技能や職人にルーツを持つ<br class="sp">「木石」の思想は、素材そのものの美しさと、<br class="sp">余白を生かした静けさを大切にします。<br>その感性を基盤に、名古屋の<br class="sp">人の営みを体感できる場を設計します。<br><br>土地の物語と素材の温もりを<br class="sp">静かに深く味わう。<br class="pc">その土地を楽しむ<br class="sp">新しい滞在のかたち。',
