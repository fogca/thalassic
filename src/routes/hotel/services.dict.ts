...
export const dict = {
  ...
  mokuseki: {
    ja: 'わたしたちが大切にする「木石」の思想、それは自然との調和であり、日々の喧騒から静寂をもたらすものです。木は暖かさや心地良さ、活力を象徴し、石は静けさや力強さを表します。こうした素材の力を随所に散りばめることで、私たちのホスピタリティを体現しています。私たちの宿泊施設は「シンプルでいて豊かであること」、「優雅でいて気取らないこと」、「繊細でいて深く記憶に残ること」を基準に設計しています。<br><br>この思想は、名古屋という土地に留まらず、それぞれの地域が持つ固有の文化、素材、職人の技を丁寧に読み解き、空間に落とし込むことで実現します。土地の物語を静かに深く味わい、その場所でしか得られない体験を通じて、訪れる人の記憶に刻まれる滞在を創造する。それが私たちの目指す宿泊施設の在り方です。',
    zh: '我们珍视的"木石"思想，体现了与自然的和谐，为日常喧嚣带来静谧。木象征温暖、舒适与活力，石代表宁静与力量。通过将这些材质的力量融入空间各处，我们诠释着自己的待客之道。我们的住宿设施以"简约而丰富"、"优雅而不矫饰"、"精致而深刻铭记"为设计准则。<br><br>这一理念不仅限于名古屋。我们用心解读每个地区独有的文化、素材与匠人技艺，将其转化为空间体验。通过静静品味土地的故事，提供只有该地才能获得的体验，创造镌刻于访客记忆中的住宿。这正是我们追求的酒店形态。',
    en: "Our philosophy, 'Mokseki' (wood and stone), embodies harmony with nature and quiet retreat from daily noise. Wood symbolizes warmth, comfort, and vitality; stone represents stillness and strength. These materials shape our hospitality throughout the space. We design our accommodations guided by three principles: simplicity with richness, elegance without pretense, and subtlety that lingers in memory.<br><br>This philosophy extends beyond Nagoya. We carefully interpret each region unique culture, materials, and craftsmanship, translating them into spatial experiences. By quietly savoring a place's story and offering experiences only possible in that locale, we create stays that become lasting memories. This is our vision for hospitality."
  },
  accommodation: {
    ja: '運営する宿泊施設',
    zh: '租赁管理',
