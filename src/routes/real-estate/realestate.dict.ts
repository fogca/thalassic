...
export const dict = {
  ...
  real1p: {
    ...
    en: 'Thalassic Real Estate provides integrated real estate services across the lifecycle of income-producing properties: Acquisition, Revitalisation, Brokerage and Management. We focus on overlooked opportunities, combining disciplined analysis with local market insight to acquire and reposition underperforming assets into stable, income-generating investments. <br><br>Through hands-on management, we enhance cash flow, tenant quality, and long-term asset performance—supporting owners with practical, results-driven solutions. Our investment-focused brokerage delivers transactions that are transparent, efficient and professionally managed.'
  },
  real2h: {
    ja: '事例紹介',
    zh: '案例介绍',
